...
namespace calculodeequipamentos.Areas.Identity.Pages.Account
{
    public class LoginWith2faModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(7, ErrorMessage = "O {0} deve possuir no mínimo {2} caracteres e no máximo {1} caractere.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Usuário com o ID '{UserId}' logado com 2fa.", user.Id);
                return LocalRedirect(returnUrl);
            }
            else if (result.IsLockedOut)
            {
                _logger.LogWarning("Usuário com o ID '{UserId}' conta bloqueada.", user.Id);
